 ...
 */
async function getForecast(category, horizon = '1M') {
 ...
 */
async function getAllForecasts(horizon = '1M') {
 ...
 */
async function getForecastAssumptions() {
  return [
 ...
 */
async function runSensitivityAnalysis(category, variableName, rangeMin, rangeMax) {
  const steps = 5;
 ...
 */
async function saveForecastSnapshot(userId, category, horizon) {
