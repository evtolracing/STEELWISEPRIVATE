 ...
 */
async function recordOutcome(decisionId, actualOutcome) {
 ...
 */
async function getDecisionStats(dateRange = 30) {
 ...
 */
async function compareDecisions(decisionIds) {
  const decisions = [];
 ...
 */
async function generateBoardReport(dateRange = 30) {
